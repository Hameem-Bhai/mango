  ...
  return (
    <div className="fixed bottom-20 md:bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden flex flex-col min-w-[220px]"
          >
            <div className="px-4 py-2.5 bg-gray-50 dark:bg-[#222] border-b border-gray-100 dark:border-gray-800">
              <p className="text-xs font-bold text-[#076136] uppercase tracking-wide">Mr. Mango Kuril Outlet</p>
      ...
      <button
        ...
        className="bg-[#25D366] text-white p-3 rounded-full shadow-lg hover:bg-[#20b858] transition-colors relative"
